...
# Project:  BHAPI.pro
# Template: lib
# Command: C:\Qt\Qt5.5.1\5.5\mingw492_32\bin\qmake.exe -spec win32-g++ -o Makefile BHAPI.pro
#############################################################################
...
Makefile: BHAPI.pro C:/Qt/Qt5.5.1/5.5/mingw492_32/mkspecs/win32-g++/qmake.conf C:/Qt/Qt5.5.1/5.5/mingw492_32/mkspecs/features/spec_pre.prf \
		...
		BHAPI.pro
	$(QMAKE) -spec win32-g++ -o Makefile BHAPI.pro
