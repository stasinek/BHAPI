# 1 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/zlib/gzlib.c"
...
# 9 "C:/Qt/Tools/mingw492_32/i686-w64-mingw32/include/stdio.h" 3
...
# 22 "C:/Qt/Tools/mingw492_32/i686-w64-mingw32/include/vadefs.h" 3
...
# 101 "C:/Qt/Tools/mingw492_32/i686-w64-mingw32/include/vadefs.h" 3
#pragma pack(pop)
...
# 656 "C:/Qt/Tools/mingw492_32/i686-w64-mingw32/include/_mingw.h" 3
...
# 10 "C:/Qt/Tools/mingw492_32/i686-w64-mingw32/include/stdio.h" 2 3
...
# 1740 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/zlib/zlib.h"
...
extern int gzvprintf (gzFile file, const char *format, va_list va)
                                                              ...
                                                              ;
# 23 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/zlib/gzguts.h" 2
...
# 25 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/zlib/gzguts.h" 2
...
# 26 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/zlib/gzguts.h" 2
# 1 "C:/Qt/Tools/mingw492_32/lib/gcc/i686-w64-mingw32/4.9.2/include-fixed/limits.h" 1 3 4
...
# 7 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/zlib/gzlib.c" 2
# 19 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/zlib/gzlib.c"
static void gz_reset (gz_statep);
static gzFile gz_open (const void *, int, const char *);
# 75 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/zlib/gzlib.c"
    ...
    const char *mode;
{
    ...
    if (state->mode == 7247) {
        state->start = _lseeki64(state->fd, 0, 1);
    ...
    int whence;
{
    ...
    if (state->mode == 7247 && state->how == 1 &&
        ...
        ret = _lseeki64(state->fd, offset - state->x.have, 1);
        if (ret == -1)
            return -1;
        state->x.have = 0;
        state->eof = 0;
    ...
    if (state->mode == 7247) {
        n = (sizeof(int) == sizeof(off64_t) && (state->x.have) > 2147483647) || (off64_t)state->x.have > offset ?
