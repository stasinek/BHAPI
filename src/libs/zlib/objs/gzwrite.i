# 1 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/zlib/gzwrite.c"
...
# 7 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/zlib/gzwrite.c" 2
    ...
    int flush;
{
    ...
    if (state->direct) {
        ...
        if (got < 0 || (unsigned)got != strm->avail_in) {
            gz_error(state, (-1), strerror((*_errno())));
            return -1;
        }
        strm->avail_in = 0;
        return 0;
    ...
    off64_t len;
{
    ...
    first = 1;
    while (len) {
        n = (sizeof(int) == sizeof(off64_t) && (state->size) > 2147483647) || (off64_t)state->size > len ?
...
# 1 "C:/Qt/Tools/mingw492_32/i686-w64-mingw32/include/stdarg.h" 1 3 4
# 2 "C:/Qt/Tools/mingw492_32/lib/gcc/i686-w64-mingw32/4.9.2/include/stdarg.h" 2 3 4
# 308 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/zlib/gzwrite.c" 2
...
int gzvprintf(gzFile file, const char *format, va_list va)
{
    ...
    size = (int)(state->size);
    state->in[size - 1] = 0;
# 357 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/zlib/gzwrite.c"
...
# 465 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/zlib/gzwrite.c"
