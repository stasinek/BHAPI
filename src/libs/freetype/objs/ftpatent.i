# 1 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/base/ftpatent.c"
# 1 "C:\\Documents and Settings\\stasiek.TC12\\My Documents\\prc++\\x86_libraries\\BHAPI\\src\\libs\\freetype\\objs//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/base/ftpatent.c"
# 18 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/base/ftpatent.c"
...
# 19 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/base/ftpatent.c" 2
...
# 20 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/base/ftpatent.c" 2
...
# 21 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/base/ftpatent.c" 2
...
# 22 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/base/ftpatent.c" 2
...
# 23 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/base/ftpatent.c" 2
# 1 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/include/freetype/internal/services/svsfnt.h" 1
# 23 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/include/freetype/internal/services/svsfnt.h"
...
# 24 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/include/freetype/internal/services/svsfnt.h" 2



# 39 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/include/freetype/internal/services/svsfnt.h"
  typedef FT_Error
  ...
  typedef struct FT_Service_SFNT_TableRec_ FT_Service_SFNT_TableRec ; typedef struct FT_Service_SFNT_TableRec_ const * FT_Service_SFNT_Table ; struct FT_Service_SFNT_TableRec_
  {
...
# 24 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/base/ftpatent.c" 2
...
# 25 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/base/ftpatent.c" 2
                              ...
                              FT_ULong size )
  {
    ...
    if ( ( ( error = ((FT_Stream_EnterFrame( stream, size ))) ) != 0 ) )
      return 0;
                              ...
                              FT_ULong tag )
  {
    ...
    do { FT_Module module = ((FT_Module)( ((FT_Face)(face))->driver )); FT_Pointer _tmp_ = ((void *)0); if ( module->clazz->get_interface ) _tmp_ = module->clazz->get_interface( module, "sfnt-table" ); service = _tmp_; } while ( 0 );
    ...
    if ( service )
    {
      ...
      if ( error ||
           ( ( error = (FT_Stream_Seek( stream, offset )) ) != 0 ) )
        goto Exit;
  ...
  _tt_face_check_patents( FT_Face face )
  {
    ...
    result = _tt_check_patents_in_table( face, ( ( (FT_ULong)'f' << 24 ) | ( (FT_ULong)'p' << 16 ) | ( (FT_ULong)'g' << 8 ) | (FT_ULong)'m' ) );
    if ( result )
      goto Exit;

    result = _tt_check_patents_in_table( face, ( ( (FT_ULong)'p' << 24 ) | ( (FT_ULong)'r' << 16 ) | ( (FT_ULong)'e' << 8 ) | (FT_ULong)'p' ) );
    if ( result )
      goto Exit;

    do { FT_Module module = ((FT_Module)( ((FT_Face)(face))->driver )); FT_Pointer _tmp_ = ((void *)0); if ( module->clazz->get_interface ) _tmp_ = module->clazz->get_interface( module, "tt-glyf" ); service = _tmp_; } while ( 0 );
    if ( service == ((void *)0) )
      goto Exit;
    ...
    for ( gindex = 0; gindex < (FT_UInt)face->num_glyphs; gindex++ )
    {
      ...
      if ( ( ( error = (FT_Stream_Seek( stream, offset )) ) != 0 ) ||
           ( num_contours = (FT_Short)FT_Stream_ReadShort( stream, &error ), error != FT_Err_Ok ) )
        continue;

      if ( num_contours >= 0 )
      {
        if ( ( ( error = (FT_Stream_Skip( stream, 8 + num_contours * 2 )) ) != 0 ) )
          continue;
      }
      else
      {
        ...
        if ( ( ( error = (FT_Stream_Skip( stream, 8 )) ) != 0 ) )
          continue;
        ...
        for (;;)
        {
          ...
          if( ( flags = (FT_UShort)FT_Stream_ReadShort( stream, &error ), error != FT_Err_Ok ) )
            break;
          ...
          if ( ( ( error = (FT_Stream_Skip( stream, toskip )) ) != 0 ) )
            goto NextGlyph;
      ...
      if ( ( num_ins = (FT_UShort)FT_Stream_ReadShort( stream, &error ), error != FT_Err_Ok ) )
        continue;
