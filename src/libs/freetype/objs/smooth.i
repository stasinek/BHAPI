# 1 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/smooth.c"
# 1 "C:\\Documents and Settings\\stasiek.TC12\\My Documents\\prc++\\x86_libraries\\BHAPI\\src\\libs\\freetype\\objs//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/smooth.c"
# 21 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/smooth.c"
...
# 22 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/smooth.c" 2
# 1 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/ftgrays.c" 1
# 140 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/ftgrays.c"
# 1 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/ftgrays.h" 1
# 31 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/ftgrays.h"
...
# 32 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/ftgrays.h" 2
# 47 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/ftgrays.h"
  extern const FT_Raster_Funcs ft_grays_raster;
# 141 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/ftgrays.c" 2
...
# 142 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/ftgrays.c" 2
...
# 143 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/ftgrays.c" 2
...
# 144 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/ftgrays.c" 2

# 1 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/ftsmerrs.h" 1
# 36 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/ftsmerrs.h"
# 1 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/include/freetype/fterrors.h" 1
# 162 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/include/freetype/fterrors.h"
  enum {
...
# 168 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/include/freetype/fterrors.h" 2
  ...
  Smooth_Err_Max };
# 37 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/ftsmerrs.h" 2
# 146 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/ftgrays.c" 2
# 224 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/ftgrays.c"
  typedef int TCoord;
  typedef long TPos;
# 241 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/ftgrays.c"
  typedef int TArea;
# 251 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/ftgrays.c"
  ...
  static void
  gray_record_cell( PWorker worker )
  {
  ...
  static void
  gray_set_cell( PWorker worker, TCoord ex,
                          TCoord ey )
  {
# 467 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/ftgrays.c"
    ey -= (*worker).min_ey;
  ...
  static void
  gray_start_cell( PWorker worker, TCoord ex,
                            TCoord ey )
  {
    if ( ex > (*worker).max_ex )
  ...
  static void
  gray_render_scanline( PWorker worker, TCoord ey,
                                 TPos x1,
                                 TCoord y1,
                                 TPos x2,
                                 TCoord y2 )
  {
    ...
    ex1 = ( (TCoord)( (x1) >> 8 ) );
    ex2 = ( (TCoord)( (x2) >> 8 ) );
    fx1 = (TCoord)( x1 - ( (TPos)(ex1) << 8 ) );
    fx2 = (TCoord)( x2 - ( (TPos)(ex2) << 8 ) );
    ...
    delta = y2 - y1;
    (*worker).area += (TArea)( fx2 + ( 1L << 8 ) - first ) * delta;
    (*worker).cover += delta;
  }
  ...
  static void
  gray_render_line( PWorker worker, TPos to_x,
                             TPos to_y )
  {
    ...
    ey1 = ( (TCoord)( ((*worker).last_ey) >> 8 ) );
    ey2 = ( (TCoord)( (to_y) >> 8 ) );
    fy1 = (TCoord)( (*worker).y - (*worker).last_ey );
    fy2 = (TCoord)( to_y - ( (TPos)(ey2) << 8 ) );
    ...
    if ( dx == 0 )
    {
      TCoord ex = ( (TCoord)( ((*worker).x) >> 8 ) );
      TCoord two_fx = (TCoord)( ( (*worker).x - ( (TPos)(ex) << 8 ) ) << 1 );
      TPos area;
    ...
    x = (*worker).x + delta;
    gray_render_scanline( worker, ey1, (*worker).x, fy1, x, (TCoord)first );

    ey1 += incr;
    gray_set_cell( worker, ( (TCoord)( (x) >> 8 ) ), ey1 );
    ...
    gray_render_scanline( worker, ey1, x,
                                   (TCoord)( ( 1L << 8 ) - first ), to_x,
                                   fy2 );

  End:
    (*worker).x = to_x;
    (*worker).y = to_y;
    (*worker).last_ey = ( (TPos)(ey2) << 8 );
  }
  ...
  static void
  gray_render_conic( PWorker worker, const FT_Vector* control,
                              const FT_Vector* to )
  {
    TPos dx, dy;
    int top, level;
    ...
    dx = ( ((*worker).x) >> ( 8 - 6 ) ) + to->x - ( control->x << 1 );
    if ( dx < 0 )
      dx = -dx;
    dy = ( ((*worker).y) >> ( 8 - 6 ) ) + to->y - ( control->y << 1 );
    if ( dy < 0 )
      dy = -dy;
    if ( dx < dy )
      dx = dy;
    ...
    if ( level <= 1 )
    {
      ...
      to_x = ( (to->x) << ( 8 - 6 ) );
      to_y = ( (to->y) << ( 8 - 6 ) );
      mid_x = ( (*worker).x + to_x + 2 * ( (control->x) << ( 8 - 6 ) ) ) / 4;
      mid_y = ( (*worker).y + to_y + 2 * ( (control->y) << ( 8 - 6 ) ) ) / 4;

      gray_render_line( worker, mid_x, mid_y );
  ...
  static void
  gray_render_cubic( PWorker worker, const FT_Vector* control1,
                              const FT_Vector* control2,
                              const FT_Vector* to )
  {
    TPos dx, dy, da, db;
    ...
    dx = ( ((*worker).x) >> ( 8 - 6 ) ) + to->x - ( control1->x << 1 );
    if ( dx < 0 )
      dx = -dx;
    dy = ( ((*worker).y) >> ( 8 - 6 ) ) + to->y - ( control1->y << 1 );
    if ( dy < 0 )
      dy = -dy;
    if ( dx < dy )
      dx = dy;
    ...
    dx = ( ((*worker).x) >> ( 8 - 6 ) ) + to->x - 3 * ( control1->x + control2->x );
    if ( dx < 0 )
      dx = -dx;
    dy = ( ((*worker).y) >> ( 8 - 6 ) ) + to->y - 3 * ( control1->x + control2->y );
    if ( dy < 0 )
      dy = -dy;
    if ( dx < dy )
      dx = dy;
    ...
    if ( level <= 1 )
    {
      ...
      to_y = ( (to->y) << ( 8 - 6 ) );
      mid_x = ( (*worker).x + to_x +
                3 * ( (control1->x + control2->x) << ( 8 - 6 ) ) ) / 8;
      mid_y = ( (*worker).y + to_y +
                3 * ( (control1->y + control2->y) << ( 8 - 6 ) ) ) / 8;
    ...
    while ( top >= 0 )
    {
      ...
      if ( level > 1 )
      {
        ...
        if ( y < min ) min = y;
        if ( y > max ) max = y;
        if ( ( (TCoord)( (min) >> 8 ) ) >= (*worker).max_ey || ( (TCoord)( (max) >> 8 ) ) < 0 )
          goto Draw;
  ...
  static void
  gray_hline( PWorker worker, TCoord x,
                       TCoord y,
                       TPos area,
                       int acount )
  {
...
# 1251 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/ftgrays.c"
...
# 1294 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/ftgrays.c"
  static void
  gray_sweep( PWorker worker, const FT_Bitmap* target )
  {
    int yindex;
...
# 1596 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/ftgrays.c"
  ...
  static int
  gray_convert_glyph_inner( PWorker worker )
  {
    static
    const FT_Outline_Funcs func_interface =
    {
      (FT_Outline_MoveToFunc) gray_move_to,
      (FT_Outline_LineToFunc) gray_line_to,
      (FT_Outline_ConicToFunc)gray_conic_to,
      (FT_Outline_CubicToFunc)gray_cubic_to,
      0,
      0
    };
    ...
    if ( _setjmp3((*(jmp_buf*) &((*worker).jump_buffer)), ((void *)0)) == 0 )
    {
                      ...
                      const FT_Raster_Params* params )
  {
    ...
    if ( !raster || !raster->buffer || !raster->buffer_size )
      return Smooth_Err_Bad_Argument;
...
# 1909 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/ftgrays.c"
  static int
                   ...
                   FT_Raster* araster )
  {
    ...
    *araster = 0;
    if ( !( ((raster) = (ft_mem_alloc( memory, (sizeof ( TRaster )), &error ))), error != 0 ) )
    {
  ...
  const FT_Raster_Funcs ft_grays_raster =
  {
    ...
    (FT_Raster_NewFunc) gray_raster_new,
    (FT_Raster_ResetFunc) gray_raster_reset,
    (FT_Raster_SetModeFunc)0,
    (FT_Raster_RenderFunc) gray_raster_render,
    (FT_Raster_DoneFunc) gray_raster_done
  };
# 23 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/smooth.c" 2
# 1 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/ftsmooth.c" 1
# 22 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/ftsmooth.c"
# 1 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/ftsmooth.h" 1
# 27 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/ftsmooth.h"
...
# 23 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/ftsmooth.c" 2
...
# 197 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/ftsmooth.c"
    ...
    if ( ( ((bitmap->buffer) = (ft_mem_alloc( memory, ((FT_ULong)pitch * height), &error ))), error != 0 ) )
      goto Exit;
    ...
    params.flags = 0x1;
# 259 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/ftsmooth.c"
...
# 24 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/smooth/smooth.c" 2
