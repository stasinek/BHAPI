# 1 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/base/ftbitmap.c"
# 1 "C:\\Documents and Settings\\stasiek.TC12\\My Documents\\prc++\\x86_libraries\\BHAPI\\src\\libs\\freetype\\objs//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/base/ftbitmap.c"
# 20 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/base/ftbitmap.c"
...
# 21 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/base/ftbitmap.c" 2
...
# 22 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/base/ftbitmap.c" 2
...
# 23 "C:/Documents and Settings/stasiek.TC12/My Documents/My Projects/X86_LIBRARIES/freetype/src/base/ftbitmap.c" 2
                  ...
                  FT_Bitmap *target)
  {
    ...
    if ( target->buffer )
    {
      ...
      if ( target_size != size )
        (void)( ((target->buffer) = (ft_mem_qrealloc( memory, 1, (target_size), (size), (target->buffer), &error ))), error != 0 );
    }
    else
      (void)( ((target->buffer) = (ft_mem_qalloc( memory, (size), &error ))), error != 0 );
                           ...
                           FT_UInt ypixels )
  {
    ...
    if ( ( ((buffer) = (ft_mem_qrealloc( memory, (bitmap->rows + ypixels), 0, (new_pitch), ((void *)0), &error ))), error != 0 ) )
      return error;
    ...
    if ( bitmap->pitch > 0 )
    {
      ...
      for ( i = 0; i < bitmap->rows; i++ )
        memcpy( buffer + new_pitch * ( ypixels + i ), bitmap->buffer + pitch * i, len )
                                                      ;
    }
    else
    {
      ...
      for ( i = 0; i < bitmap->rows; i++ )
        memcpy( buffer + new_pitch * i, bitmap->buffer + pitch * i, len )
                                                      ;
    }
                      ...
                      FT_Pos yStrength )
  {
    ...
    xstr = ( ((xStrength) + 32) & ~63 ) >> 6;
    ystr = ( ((yStrength) + 32) & ~63 ) >> 6;
    ...
    case FT_PIXEL_MODE_GRAY4:
      {
        ...
        if ( target->rows * target->pitch > old_size &&
             ( ((target->buffer) = (ft_mem_qrealloc( memory, 1, (old_size), (target->rows * target->pitch), (target->buffer), &error ))), error != 0 )
                                                                   )
          return error;
      }
      break;
