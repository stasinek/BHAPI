...
typedef void (*fssh_transaction_notification_hook)(int32_t_t id, int32_t_t event,
	void *data);
...
/* transactions */
extern int32_t_t			fssh_cache_start_transaction(void *_cache);
extern fssh_status_t	fssh_cache_sync_transaction(void *_cache, int32_t_t id);
extern fssh_status_t	fssh_cache_end_transaction(void *_cache, int32_t_t id,
							fssh_transaction_notification_hook hook,
							void *data);
extern fssh_status_t	fssh_cache_abort_transaction(void *_cache, int32_t_t id);
extern int32_t_t			fssh_cache_detach_sub_transaction(void *_cache,
							int32_t_t id, fssh_transaction_notification_hook hook,
							void *data);
...
extern fssh_status_t	fssh_cache_next_block_in_transaction(void *_cache,
							int32_t_t id, bool mainOnly, long *_cookie,
							fssh_off_t *_blockNumber, void **_data,
							void **_unchangedData);
extern int32_t_t			fssh_cache_blocks_in_transaction(void *_cache,
							int32_t_t id);
extern int32_t_t			fssh_cache_blocks_in_main_transaction(void *_cache,
							int32_t_t id);
extern int32_t_t			fssh_cache_blocks_in_sub_transaction(void *_cache,
							int32_t_t id);
...
extern void				fssh_file_map_invalidate(void *_map, fssh_off_t offset,
							fssh_off_t size);
extern fssh_status_t	fssh_file_map_set_mode(void *_map, uint32_t_t mode);
