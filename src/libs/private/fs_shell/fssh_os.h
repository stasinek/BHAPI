...
typedef int32_t_t fssh_area_id;
typedef int32_t_t	fssh_port_id;
typedef int32_t_t	fssh_sem_id;
typedef int32_t_t	fssh_team_id;
typedef int32_t_t	fssh_thread_id;
...
extern fssh_sem_id		fssh_create_sem(int32_t_t count, const char *name);
extern fssh_status_t	fssh_delete_sem(fssh_sem_id id);
extern fssh_status_t	fssh_acquire_sem(fssh_sem_id id);
extern fssh_status_t	fssh_acquire_sem_etc(fssh_sem_id id, int32_t_t count,
							uint32_t_t flags, fssh_bigtime_t timeout);
extern fssh_status_t	fssh_release_sem(fssh_sem_id id);
extern fssh_status_t	fssh_release_sem_etc(fssh_sem_id id, int32_t_t count,
							uint32_t_t flags);
extern fssh_status_t	fssh_get_sem_count(fssh_sem_id id,
							int32_t_t *threadCount);
...
extern fssh_status_t	_fssh_get_next_sem_info(fssh_team_id team,
							int32_t_t *cookie, struct fssh_sem_info *info,
...
extern fssh_status_t	fssh_send_data(fssh_thread_id thread, int32_t_t code,
							const void *buffer,
						fssh_size_t bufferSize);
extern int32_t_t			fssh_receive_data(fssh_thread_id *sender, void *buffer,
							fssh_size_t bufferSize);
...
extern fssh_status_t	_fssh_get_next_thread_info(fssh_team_id team,
							int32_t_t *cookie, fssh_thread_info *info,
							fssh_size_t size);
...
extern uint32_t_t			fssh_real_time_clock(void);
extern void				fssh_set_real_time_clock(uint32_t_t secs_since_jan1_1970);
