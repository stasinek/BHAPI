...
extern fssh_ssize_t	fssh_fs_read_attr(int fd, const char *attribute,
							uint32_t_t type, fssh_off_t pos, void *buffer,
							fssh_size_t readBytes);
extern fssh_ssize_t	fssh_fs_write_attr(int fd, const char *attribute,
							uint32_t_t type, fssh_off_t pos, const void *buffer,
							fssh_size_t readBytes);
...
//extern int		fssh_fs_open_attr(const char *path, const char *attribute, uint32_t_t type, int openMode);
extern int			fssh_fs_open_attr(int fd, const char *attribute,
							uint32_t_t type, int openMode);
