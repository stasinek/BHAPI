 ...
 # options passed:  -fpreprocessed openssl.ii -malign-double
 # -momit-leaf-frame-pointer -m32 -mfpmath=sse -mpreferred-stack-boundary=8
 # -mmmx -msse -msse2 -mthreads -mtune=generic -march=i686
 # -auxbase-strip debug/openssl.o -g -g -Wno-write-strings -Wno-multichar
 ...
 # -Wshadow -Wunknown-pragmas -Wall -Wextra -std=c++11 -std=gnu++11
 ...
 # -mstack-arg-probe
	...
	.text
Ltext0:
	.section	.gnu.lto_.inline.1b2db783,"dr0"
	.ascii "x\234cf\300\16\230\340,\0\0\234\0\6"
	.text
	.section	.gnu.lto_.symbol_nodes.1b2db783,"dr0"
	.ascii "x\234cf```b\200\1\0\0L\0\6"
	.text
	.section	.gnu.lto_.refs.1b2db783,"dr0"
	.ascii "x\234cf```d\200\2\0\0=\0\5"
	.text
	.section	.gnu.lto_.decls.1b2db783,"dr0"
	.ascii "x\234cf``P\1\342\377@\0\244\30\30\241\330\237\201\0\0\0\320\27\4u"
	.text
	.section	.gnu.lto_.symtab.1b2db783,"dr0"
	.text
