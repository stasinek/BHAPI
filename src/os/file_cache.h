...
struct cache_module_info {
	...
	void (*node_opened)(struct vnode *vnode, int32_t fdType, dev_t mountID,
				ino_t parentID, ino_t vnodeID, const char *name, off_t size);
	void (*node_closed)(struct vnode *vnode, int32_t fdType, dev_t mountID,
				ino_t vnodeID, int32_t accessType);
...
extern void cache_node_opened(struct vnode *vnode, int32_t fdType, VMCache *cache,
				dev_t mountID, ino_t parentID, ino_t vnodeID, const char *name);
extern void cache_node_closed(struct vnode *vnode, int32_t fdType, VMCache *cache,
