...
partition_id
_kern_get_next_disk_device_id(int32_t *cookie, size_t *neededSize)
{
	return -1;
}
...
status_t _kern_unregister_file_device(partition_id deviceID, const char *filename)
{
	return B_ERROR;
}
...
status_t _kern_get_next_disk_system_info(int32_t *cookie,
	struct user_disk_system_info *info)
{
	return B_ERROR;
}
...
status_t _kern_find_disk_system(const char *name,
	struct user_disk_system_info *info)
{
	return B_ERROR;
}
...
status_t _kern_validate_resize_partition(partition_id partitionID, int32_t changeCounter,
	off_t *size)
{
	return B_ERROR;
}
...
status_t _kern_validate_move_partition(partition_id partitionID, int32_t changeCounter,
	off_t *newOffset)
{
	return B_ERROR;
}
...
status_t _kern_validate_set_partition_name(partition_id partitionID, int32_t changeCounter,
	char *name)
{
	return B_ERROR;
}
...
status_t _kern_validate_set_partition_type(partition_id partitionID, int32_t changeCounter,
	const char *type)
{
	return B_ERROR;
}
...
status_t _kern_validate_initialize_partition(partition_id partitionID,
	int32_t changeCounter, const char *diskSystemName, char *name,
...
status_t _kern_get_partitionable_spaces(partition_id partitionID, int32_t changeCounter,
	struct partitionable_space_data *buffer, int32_t count, int32_t *actualCount)
{
	return B_ERROR;
}
...
status_t _kern_defragment_partition(partition_id partitionID, int32_t changeCounter)
{
	return B_ERROR;
}


status_t _kern_repair_partition(partition_id partitionID, int32_t changeCounter,
	bool checkOnly)
{
	return B_ERROR;
}
...
status_t _kern_resize_partition(partition_id partitionID, int32_t changeCounter,
	off_t size)
{
	return B_ERROR;
}
...
status_t _kern_move_partition(partition_id partitionID, int32_t changeCounter,
	off_t newOffset)
{
	return B_ERROR;
}
...
status_t _kern_set_partition_name(partition_id partitionID, int32_t changeCounter,
	const char *name)
{
	return B_ERROR;
}
...
status_t _kern_set_partition_type(partition_id partitionID, int32_t changeCounter,
	const char *type)
{
	return B_ERROR;
}
...
status_t _kern_set_partition_parameters(partition_id partitionID, int32_t changeCounter,
	const char *parameters, size_t parametersSize)
{
	return B_ERROR;
}
...
status_t _kern_set_partition_content_parameters(partition_id partitionID,
	int32_t changeCounter, const char *parameters, size_t parametersSize)
{
	return B_ERROR;
}


status_t _kern_initialize_partition(partition_id partitionID, int32_t changeCounter,
...
status_t _kern_uninitialize_partition(partition_id partitionID, int32_t changeCounter)
{
	return B_ERROR;
}


status_t _kern_create_child_partition(partition_id partitionID, int32_t changeCounter,
...
status_t _kern_delete_partition(partition_id partitionID, int32_t changeCounter)
{
	return B_ERROR;
}


status_t _kern_delete_child_partition(partition_id partitionID, int32_t* changeCounter,
...
status_t _kern_get_next_disk_device_job_info(int32_t *cookie,
...
status_t _kern_get_safemode_option(const char *parameter, char *buffer,
	size_t *_bufferSize)
{
	return B_ERROR;
}
