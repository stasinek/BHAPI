...
status_t _kern_validate_resize_partition(partition_id partitionID, int32 changeCounter,
	off_t *size)
{
	return B_ERROR;
}
...
status_t _kern_validate_move_partition(partition_id partitionID, int32 changeCounter,
	off_t *newOffset)
{
	return B_ERROR;
}
...
status_t _kern_validate_set_partition_name(partition_id partitionID, int32 changeCounter,
	char *name)
{
	return B_ERROR;
}
...
status_t _kern_validate_set_partition_type(partition_id partitionID, int32 changeCounter,
	const char *type)
{
	return B_ERROR;
}
...
status_t _kern_get_partitionable_spaces(partition_id partitionID, int32 changeCounter,
...
status_t _kern_defragment_partition(partition_id partitionID, int32 changeCounter)
{
	return B_ERROR;
}
...
status_t _kern_set_partition_name(partition_id partitionID, int32 changeCounter,
	const char *name)
{
	return B_ERROR;
}
...
status_t _kern_set_partition_type(partition_id partitionID, int32 changeCounter,
	const char *type)
{
	return B_ERROR;
}
...
status_t _kern_set_partition_parameters(partition_id partitionID, int32 changeCounter,
	const char *parameters, size_t parametersSize)
{
	return B_ERROR;
}
...
status_t _kern_initialize_partition(partition_id partitionID, int32 changeCounter,
...
status_t _kern_uninitialize_partition(partition_id partitionID, int32 changeCounter)
{
	return B_ERROR;
}


status_t _kern_create_child_partition(partition_id partitionID, int32 changeCounter,
...
status_t _kern_delete_child_partition(partition_id partitionID, int32* changeCounter,
