...
/*static*/ inline page_table_entry
PPCPagingMethodClassic::ClearPageTableEntryFlags(page_table_entry* entry, uint32_t flags)
{
...
PPCPagingMethodClassic::MemoryTypeToPageTableEntryFlags(uint32_t memoryType)
{
