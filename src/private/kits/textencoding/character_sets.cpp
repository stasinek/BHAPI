...
static const BCharacterSet isoLatin1(1,4, B_TRANSLATE("ISO West European"),"ISO_8859-1:1987","ISO-8859-1",isoLatin1aliases);
...
static const BCharacterSet isoLatin2(2,5, B_TRANSLATE("ISO East European"),"ISO_8859-2:1987","ISO-8859-2",isoLatin2aliases);
...
static const BCharacterSet isoLatin3(3,6, B_TRANSLATE("ISO South European"),"ISO_8859-3:1988","ISO-8859-3",isoLatin3aliases);
...
static const BCharacterSet isoLatin4(4,7, B_TRANSLATE("ISO North European"),"ISO_8859-4:1988","ISO-8859-4",isoLatin4aliases);
...
static const BCharacterSet isoLatin5(5,8, B_TRANSLATE("ISO Cyrillic"),"ISO_8859-5:1988","ISO-8859-5",isoLatin5aliases);
...
static const BCharacterSet isoLatin6(6,9, B_TRANSLATE("ISO Arabic"),"ISO_8859-6:1987","ISO-8859-6",isoLatin6aliases);
...
static const BCharacterSet isoLatin7(7,10, B_TRANSLATE("ISO Greek"),"ISO_8859-7:1987","ISO-8859-7",isoLatin7aliases);
...
static const BCharacterSet isoLatin8(8,11, B_TRANSLATE("ISO Hebrew"),"ISO_8859-8:1988","ISO-8859-8",isoLatin8aliases);
...
const BCharacterSet isoLatin9(9,12, B_TRANSLATE("ISO Turkish"),"ISO_8859-9:1989","ISO-8859-9",isoLatin9aliases);
...
static const BCharacterSet isoLatin10(10,13, B_TRANSLATE("ISO Nordic"),"ISO-8859-10","ISO-8859-10",isoLatin10aliases);
...
static const BCharacterSet macintosh(11,2027, B_TRANSLATE("Macintosh Roman"),"macintosh",NULL,macintoshAliases);
...
static const BCharacterSet shiftJIS(12,17, B_TRANSLATE("Japanese Shift JIS"),"Shift_JIS","Shift_JIS",shiftJISaliases);
...
static const BCharacterSet packedJapanese(13,18, B_TRANSLATE("Japanese EUC"),"Extended_UNIX_Code_Packed_Format_for_Japanese","EUC-JP",EUCPackedJapaneseAliases);
...
static const BCharacterSet iso2022jp(14,39, B_TRANSLATE("Japanese JIS"),"ISO-2022-JP","ISO-2022-JP",iso2022jpAliases);
...
static const BCharacterSet windows1252(15,2252, B_TRANSLATE("Windows Latin-1 (CP 1252)"),"windows-1252",NULL,windows1252aliases);
...
static const BCharacterSet unicode2(16,1000, B_TRANSLATE("Unicode (UCS-2)"),"ISO-10646-UCS-2",NULL,unicode2aliases);
...
static const BCharacterSet KOI8R(17,2084, B_TRANSLATE("KOI8-R Cyrillic"),"KOI8-R","KOI8-R",KOI8Raliases);
...
static const BCharacterSet windows1251(18,2251, B_TRANSLATE("Windows Cyrillic (CP 1251)"), "windows-1251",NULL,windows1251aliases);
...
static const BCharacterSet IBM866(19,2086, B_TRANSLATE("DOS Cyrillic"),"IBM866","IBM866",IBM866aliases);
...
static const BCharacterSet IBM437(20,2011, B_TRANSLATE("DOS Latin-US"),	"IBM437","IBM437",IBM437aliases);
...
static const BCharacterSet eucKR(21,38, B_TRANSLATE("EUC Korean"),"EUC-KR","EUC-KR",eucKRaliases);
...
static const BCharacterSet iso13(22,109, B_TRANSLATE("ISO Baltic"),"ISO-8859-13","ISO-8859-13",iso13aliases);
static const char * iso14aliases[] = {
    // IANA aliases
    "iso-ir-199", "ISO_8859-14:1998", "ISO_8859-14", "latin8", "iso-celtic", "l8",
    NULL
};
static const BCharacterSet iso14(23,110, B_TRANSLATE("ISO Celtic"),"ISO-8859-14","ISO-8859-14",iso14aliases);
...
static const BCharacterSet iso15(24,111, B_TRANSLATE("ISO Latin 9"),"ISO-8859-15","ISO-8859-15",iso15aliases);
...
static const BCharacterSet big5(25,2026, B_TRANSLATE("Chinese Big5"),"Big5","Big5",big5aliases);
...
static const BCharacterSet gb18030(26,114, B_TRANSLATE("Chinese GB18030"),"GB18030",NULL,gb18030aliases);
...
static const BCharacterSet kUTF16(27, 1000, B_TRANSLATE("Unicode"), "UTF-16", "UTF-16",kUTF16Aliases);
...
static const BCharacterSet kWindows1250(28, 2250, B_TRANSLATE("Windows Central European (CP 1250)"), "windows-1250", NULL, kWindows1250Aliases);
/**
