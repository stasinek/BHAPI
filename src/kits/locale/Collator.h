...
#ifndef BHAPI_COLLATOR_H
#define BHAPI_COLLATOR_H
...
inline bool BCollator::Equal(const char *s1, const char *s2, int8 strength) const
{
    return Compare(s1, s2, strength) == 0;
}


inline bool BCollator::Greater(const char *s1, const char *s2, int8 strength) const
{
    return Compare(s1, s2, strength) > 0;
}

inline bool BCollator::GreaterOrEqual(const char *s1, const char *s2, int8 strength) const
{
    return Compare(s1, s2, strength) >= 0;
}
