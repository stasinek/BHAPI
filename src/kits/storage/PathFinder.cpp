...
status_t BPathFinder::FindPath(path_base_directory baseDirectory, BPath& _path)
{
...
/*static*/ status_t BPathFinder::FindPaths(path_base_directory baseDirectory, BStringList& _paths)
{
