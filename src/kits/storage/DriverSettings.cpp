...
bool BDriverParameterContainer::FindParameter(const char* name,
...
const char*  BDriverParameterContainer::GetParameterValue(const char* name,
...
bool BDriverParameter::IsValid() const
{
