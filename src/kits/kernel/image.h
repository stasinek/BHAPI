...
status_t _get_image_info(bhapi::image_id image, image_info *info, size_t size);
status_t _get_next_image_info(bhapi::team_id team, int32 *cookie, image_info *info,
                size_t size);
