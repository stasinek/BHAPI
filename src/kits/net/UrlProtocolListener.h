 ...
 */
#ifndef BHAPI_URL_PROTOCOL_LISTENER_H
#define BHAPI_URL_PROTOCOL_LISTENER_H

#ifdef __cplusplus // C++

#ifndef BCERTIFICATE_I
class BCertificate;
#define BCERTIFICATE_I
#endif
#ifndef BURLREQUEST_I
class BUrlRequest;
#define BURLREQUEST_I
#endif
...
class BHAPI_IMPEXP BUrlProtocolListener {
public:
    /**
        ConnectionOpened()
        Frequency:	Once
...
#endif // C++
#define BURLPROTOCOLLISTENER_I
#endif // BHAPI_URL_PROTOCOL_LISTENER_H
