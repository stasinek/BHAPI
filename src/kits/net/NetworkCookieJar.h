 ...
 */
#ifndef BHAPI_NETWORK_COOKIE_JAR_H
#define BHAPI_NETWORK_COOKIE_JAR_H
...
#define BNETWORKCOOKIE_I
#define BNETWORKCOOKIEJAR_I
#define BNETWORKCOOKIELIST_I
#endif // BHAPI_NETWORK_COOKIE_JAR_H
