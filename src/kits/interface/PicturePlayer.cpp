...
static void stroke_line(void* _context, const BPoint& start, const BPoint& end)
{
    adapter_context* context = reinterpret_cast<adapter_context*>(_context);
...
static void draw_round_rect(void* _context, const BRect& rect, const BPoint& radii,
    bool fill)
{
    adapter_context* context = reinterpret_cast<adapter_context*>(_context);
...
static void draw_bezier(void* _context, size_t numPoints, const BPoint _points[], bool fill)
{
    adapter_context* context = reinterpret_cast<adapter_context*>(_context);
    if (numPoints != 4)
        return;
...
static void draw_polygon(void* _context, size_t numPoints, const BPoint _points[],
...
static void set_clipping_rects(void* _context, size_t numRects, const BRect _rects[])
{
    adapter_context* context = reinterpret_cast<adapter_context*>(_context);
